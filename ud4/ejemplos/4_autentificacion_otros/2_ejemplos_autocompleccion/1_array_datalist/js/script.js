...
/* Array estático con los nombres de los paises */
...
/* Manejador de pulsación de tecla 
      Eliminamos todas las sugerencias previas
      A continuación construimos un datalist a partir de los paises que comienzan 
      por el texto introducido
      Asociamos el datalista al campo de texto*/
...
function pulsaTecla(e){
    ...
    paises.forEach(pais => { 
        ...
        if(pais.toLowerCase().startsWith(valor.toLowerCase())){
          ...
          sugerencia.textContent = pais;
          sugerencia.value=pais;
...
/* Elimina la lista de sugerencias.
    Necesario para resetear tras cada petición */
